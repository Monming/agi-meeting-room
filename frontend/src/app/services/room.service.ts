...
export class RoomService {
  ...
  /** JS Date#getTimezoneOffset — sent to API for UTC conversion of calendar days / slots */
   ...
   * Returns slot iso/endIso as UTC; labels match the user's local wall clock.
